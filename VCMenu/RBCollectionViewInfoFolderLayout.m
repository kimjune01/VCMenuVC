...
- (void)drawRect:(CGRect)rect
{
    ...
    CGPoint bottomLeft = CGPointMake(-5, rect.size.height+5);
    CGPoint topMiddle = CGPointMake(rect.size.width/2, -0.5);
    CGPoint bottomRight = CGPointMake(rect.size.width+5, rect.size.height+5);
    
    [polygonPath moveToPoint: bottomLeft];
    [polygonPath addLineToPoint: topMiddle];
    [polygonPath addLineToPoint: bottomRight];
